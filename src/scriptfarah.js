...
function init() {
  ...
  loader.load('farahA.glb', (gltf) => {
    model1 = gltf.scene;
    model1.scale.set(1, 1, 1);
    model1.position.set(0, 0, 0);
    model1.getObjectByName('headphone1').material.emissiveIntensity = 10;
    model1.getObjectByName('PointLight').intensity = 0.5;
    model1.getObjectByName('PointLight1').intensity = 0.5;
